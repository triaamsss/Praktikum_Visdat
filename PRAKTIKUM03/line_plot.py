...
option = st.sidebar.selectbox("Pilih Tipe Visualisasi", ("Line Plot", "Kustomisasi Line Plot", "Garis Berbeda untuk Menunjukkan Trend", "Subplot"))
...
def trend_lines_plot():
    fig, ax = plt.subplots()
    ax.plot(months, product_A_sales, label='Product A Trend', color='blue')
    ax.plot(months, product_B_sales, label='Product B Trend', color='red')
